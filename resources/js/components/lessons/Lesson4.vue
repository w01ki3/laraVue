...
watch:{
    counter(val,oldVal){
        ...
        this.process +=" | eski değer : " + oldVal
                    ...
                    <td>
                      <button class="btn btn-primary m-1" @click="counter++">[+]</button>
                      <button class="btn btn-danger m-1" @click="counter--">[-]</button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <li v-for="(row, index) in inputData" :key="index">
                        {{ row }}
                        <button class="btn btn-danger btn-sm mb-1" @click="deleteData(index)">
                          [-]
                        </button>
                      </li>
                    </td>
    ...
    deleteData(index){
        ...
        this.inputData.value = "";
                    ...
                    <td>
                      ...
                      <hr />
                      <button :disabled="errors.length > 0 || inputValue == ''" class="btn btn-primary"
                        @click="addData">
                        add [+]
                      </button>
                    </td>
